...
import { CREATE_POST,DELETE_POST,UPDATE_POST,LIST_POST,LIST_USER_POST } from "./post.type";
...
export const deletePost = createAsyncThunk(DELETE_POST, async (payload) => {
  ...
  export const listUserPost = createAsyncThunk(LIST_USER_POST, async (payload) => {
